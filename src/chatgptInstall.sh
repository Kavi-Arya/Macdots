...
if [ ! -d "$HOME/.clones/Macdots" ]; then
  ...
  git clone --depth 1 https://github.com/Kavi-Arya/Macdots.git "$HOME/.clones/Macdots"
else
...
install_brew_packages() {
  ...
  local pkgs_file="$HOME/.clones/Macdots/src/pkgs.txt"
  local casks_file="$HOME/.clones/Macdots/src/casks.txt"
...
install_shell_color_scripts() {
  ...
  local shell_color_dir="$HOME/.clones/Macdots/src/shell-color-scripts"
